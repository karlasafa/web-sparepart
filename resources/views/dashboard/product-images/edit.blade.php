                ...
                <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
                    <div class="card">
                        <div class="card-header pb-2">
                            <h6>Edit Product Image</h6>
                        </div>
                        <form class="card-body px-4 pt-0 pb-2" action="/dashboard/product-images/{{ $productImage->id }}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="mb-3">
                                <x-input-image name="source" previous="{{ $productImage->source }}"></x-input-image>
                            </div>
