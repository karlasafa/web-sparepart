    ...
    <x-slot:content>
        <div class="container-fluid py-4">
            <div class="row my-4">
                ...
                <input type="hidden" id="index-page" value="{{ url('dashboard/profile') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
                    <div class="card">
                        ...
                        <form class="card-body px-4 pt-0 pb-2" action="/dashboard/profile/{{ $user->id }}" method="POST" enctype="multipart/form-data">
                            @method("PUT")
                            @csrf
                            <div class="mb-3">
